...
abstract class ExportObject
{
     ...
     * @return \SpareMusic\DigiSigner\stdClass - standard object, populated with properties that should be serialized to JSON
     * The properties should have been declared in $this->exportProps array of each descending class.
     * @throws \SpareMusic\DigiSigner\DigiSignerException
     */
